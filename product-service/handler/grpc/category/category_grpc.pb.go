...
type CategoryServiceClient interface {
	...
	DeleteCategory(ctx context.Context, in *Category, opts ...grpc.CallOption) (*emptypb.Empty, error)
	GetCategories(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CategoryList, error)
}
...
func (c *categoryServiceClient) DeleteCategory(ctx context.Context, in *Category, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *categoryServiceClient) GetCategories(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CategoryList, error) {
	out := new(CategoryList)
	err := c.cc.Invoke(ctx, "/category.CategoryService/GetCategories", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServiceServer interface {
	...
	DeleteCategory(context.Context, *Category) (*emptypb.Empty, error)
	GetCategories(context.Context, *emptypb.Empty) (*CategoryList, error)
...
func (UnimplementedCategoryServiceServer) GetCategory(context.Context, *Category) (*Category, error) {
...
func (UnimplementedCategoryServiceServer) DeleteCategory(context.Context, *Category) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteCategory not implemented")
}
func (UnimplementedCategoryServiceServer) GetCategories(context.Context, *emptypb.Empty) (*CategoryList, error) {
...
func _CategoryService_DeleteCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).DeleteCategory(ctx, req.(*Category))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CategoryService_GetCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/category.CategoryService/GetCategories",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "handler/grpc/category/category.proto",
}
