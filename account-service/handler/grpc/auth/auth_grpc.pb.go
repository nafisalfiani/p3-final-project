...
type AuthServiceClient interface {
	...
	ListRole(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RoleList, error)
}
...
func (c *authServiceClient) ListRole(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RoleList, error) {
	out := new(RoleList)
...
type AuthServiceServer interface {
	...
	ListRole(context.Context, *emptypb.Empty) (*RoleList, error)
...
func (UnimplementedAuthServiceServer) ListRole(context.Context, *emptypb.Empty) (*RoleList, error) {
...
func _AuthService_ListRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ListRole(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "handler/grpc/auth/auth.proto",
}
